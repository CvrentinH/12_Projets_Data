# Data Analyst Portfolio: 12 Business Projects

## Overview
This repository documents a comprehensive 12-project journey designed to master the end-to-end data value chain.

Inspired by the **LeCoinStat** challenge, these projects simulate real-world business scenarios ranging from **Sales Reporting** and **HR Analytics** to **Machine Learning Predictions** and **Advanced SQL Architecture**.

## Tech Stack & Skills
* **Languages:** Python (Pandas, Scikit-learn, Statsmodels), R, SQL (Advanced).
* **Visualization:** Power BI / Tableau, Matplotlib, Seaborn.
* **Tools:** Excel (Pivot Tables, Advanced Formulas), Jupyter Notebooks.
* **Concepts:** Statistical Analysis, Hypothesis Testing, ETL, Machine Learning (Regression, Classification, Clustering), Time Series Forecasting.

---

## Projects Breakdown

### Part 1: Descriptive Analytics & Dashboards (Excel & BI)

#### **Project 1: Sales Performance Dashboard**
* **Tools:** Excel
* **Objective:** Designed an interactive dashboard to track sales KPIs, regional performance, and profit margins.
...
#### **Project 6: Wine Profile Analysis (PCA)**
* **Tools:** Python
* **Objective:** Applied dimensionality reduction to identify key chemical differentiators in wine quality for product segmentation.
* **Key Skills:** Principal Component Analysis (PCA), feature engineering, and 3D data visualization.
...
#### **Project 8: Advanced Enterprise Performance Analysis**
* **Tools:** Advanced SQL
* **Objective:** Performed complex analysis on the *AdventureWorks* database to optimize sales, segment customers, and calculate profitability.
* **Key Skills:** Complex Joins, Window Functions (Ranking, Moving Averages), CTEs, and cohort analysis.
...
#### **Project 10: Real Estate Price Prediction**
* **Tools:** Python (Scikit-learn)
* **Objective:** Built a Linear Regression model to estimate house prices based on structural and environmental features.
